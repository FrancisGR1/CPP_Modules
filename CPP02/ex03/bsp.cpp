...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/26 14:19:42 by frmiguel          #+#    #+#             */
/*   Updated: 2025/06/26 15:56:59 by frmiguel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	//calcular os vetores dos lados do triângulo
	Fixed s1 = c.getY() - a.getY();
	Fixed s2 = c.getX() - a.getX();
	Fixed s3 = b.getY() - a.getY();

	//calcular o vetor de a até "point"
